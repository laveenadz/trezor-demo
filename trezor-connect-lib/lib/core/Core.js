...
function () {
  ...
  _regenerator.default.mark(function _callee(method) {
    var isWebUsb, isNodeHid, device, devicesCount, selectedDevicePath, uiPromise, uiResp;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            isNodeHid = _deviceList.transportType().indexOf('nodehid') >= 0;
          ...
          case 7:
            ...
            if (!(devicesCount === 1 && !isWebUsb || !isNodeHid)) {
              _context.next = 13;
              break;
            }
...
var handleDeviceSelectionChanges = function handleDeviceSelectionChanges(interruptDevice) {
  ...
  if (uiPromise && _deviceList) {
    ...
    var isNodeHid = _deviceList.transportType().indexOf('nodehid') >= 0;

    if (list.length === 1 && !isWebUsb || !isNodeHid) {
