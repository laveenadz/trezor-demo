...
(0, _defineProperty2.default)(TrezorConnect, "NodeHid", function () {
  (0, _node.NodeHid)();
});
...
(0, _defineProperty2.default)(TrezorConnect, "renderNodeHidButton", function (className) {
  (0, _node.renderNodeHidButton)(className);
});
