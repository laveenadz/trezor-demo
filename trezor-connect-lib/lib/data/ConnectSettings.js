...
var initialSettings = {
  ...
  nodehidSrc: DEFAULT_DOMAIN + "nodehid.html",
...
var parse = function parse(input) {
  ...
  settings.nodehidSrc = settings.connectSrc + "nodehid.html";
  ...
  if (typeof input.nodehid === 'boolean') {
    settings.nodehid = input.nodehid;
  }
