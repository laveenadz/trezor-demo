...
import BridgeTransport from "trezor-link-node/lib/bridge/index";
import ExtensionTransport from "trezor-link-node/lib/extension/index";
import ParallelTransport from "trezor-link-node/lib/parallel";
import FallbackTransport from "trezor-link-node/lib/fallback";
import NodeHidPlugin from "trezor-link-node/lib/lowlevel/node-hid";
import LowlevelTransport from "trezor-link-node/lib/lowlevel/index";
...
//import trezor-link-node packages
var trezorLink = require('../../node_modules/trezor-link-node/src/index-browser');
console.log("line no 49",trezorLink)
// import Device from './Device';
var BridgeV2 = trezorLink.Bridge,
    Lowlevel = trezorLink.Lowlevel,
    WebUsb = undefined,
    NodeHid = trezorLink.NodeHid,
     Fallback = trezorLink.Fallback,
     Extension= trezorLink.Extension,
     Parallel = trezorLink.Parallel
...
function (_EventEmitter) {
  ...
  function DeviceList(options) {
   ...
   if (_DataManager.default.getSettings('nodehid')) {
        transportTypes.push(new Lowlevel(new NodeHid(), function () {
          return sharedWorkerFactoryWrap();
        }));
      }
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 6:
              ...
              nodeHidPlugin = this.getNodeHidPlugin();
              ...
              if (webUsbPlugin) {
                ...
                if (nodeHidPlugin) {
                    nodeHidPlugin.unreadableHidDeviceChange.on('change',
                        /*#__PURE__*/
                        (0, _asyncToGenerator2.default)(
                            /*#__PURE__*/
                            _regenerator.default.mark(function _callee() {
                                ...
                                return _regenerator.default.wrap(function _callee$(_context) {
                                    while (1) {
                                        switch (_context.prev = _context.next) {
                                            case 0:
                                                if (!nodeHidPlugin.unreadableHidDevice) {
                                                    _context.next = 8;
                                                    break;
                                                }
  ...
  _proto.getNodeHidPlugin = function getNodeHidPlugin() {
    try {
      var transport = this.transport;
      ...
      var nodehidTransport = activeTransport.plugin;

      if (!nodehidTransport || nodehidTransport.name !== 'NodeHidPlugin') {
        return null;
      }

      return nodehidTransport;
    } catch (e) {
      return null;
    }
  };
      ...
      return _regenerator.default.wrap(function _callee12$(_context12) {
        while (1) {
          switch (_context12.prev = _context12.next) {
            ...
            case 12:
              if (!(_context12.t0.message === ERROR.WRONG_PREVIOUS_SESSION_ERROR_MESSAGE || _context12.t0.toString() === ERROR.WEBUSB_ERROR_MESSAGE || _context12.t0.toString() === ERROR.NODEHID_ERROR_MESSAGE)) {
                _context12.next = 18;
                break;
              }
